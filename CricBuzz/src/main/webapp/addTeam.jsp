...
<br><br>
<input type="submit" onclick="alert('Team Successfully Added')" value="Submit" required>
</td>
</form>
<td> </td>
...
<br>
<br><br>
<input type="submit" onclick="alert('Team Successfully Deleted')" value="Submit" required>
</td>
</form>
