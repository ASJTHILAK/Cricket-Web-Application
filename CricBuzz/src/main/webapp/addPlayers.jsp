...
<br><br>
<input type="submit" onclick="alert('Player Successfully Added')" value="Submit" required>
</td>
</form>
<td> </td>
...
<br>
<br><br>
<input type="submit" onclick="alert('Player Successfully Deleted')" value="Submit" required>
</td>
</form>
